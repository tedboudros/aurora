...
Building the project on Windows with MSYS2.

Install MSYS2 if necessary, for example, in the folder 'C:\msys64'. Run C:\msys64\mingw64.exe (not msys2.exe).
...
For example, we have the project files in "Projects/aurora" and the current folder is "Projects". Next we create a separate folder for build files:
